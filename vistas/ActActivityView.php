   ...
   <section class="cuerpo">
      ...
      <div class="text-xs-center bajar" id="cuerpoPrincipal">
         <div class="container">
            ...
            <h1 class="display-5 wow bounce font-weight-bold">ACTIVIDAD</h2>

               <form action="?controller=activity&accion=actactivity&id=<?= $id ?>" method="post" enctype="multipart/form-data" id="formRegistro">
